  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-graffiti-black via-gray-900 to-graffiti-black py-20">
      <div className="container mx-auto px-4">
        ...
        <Card className="max-w-2xl mx-auto p-3 xs:p-4 sm:p-6 lg:p-12 bg-graffiti-white dark:bg-gray-800 ring-4 ring-graffiti-red relative">
          <div className="absolute -top-1 xs:-top-2 left-1/2 transform -translate-x-1/2">
          ...
          <div className="text-center pt-2 xs:pt-3 sm:pt-4">
            <h1 className="text-xl xs:text-2xl sm:text-3xl lg:text-5xl font-oswald font-bold text-graffiti-red mb-2 xs:mb-3 sm:mb-4 leading-tight">
              СТАНДАРТНЫЙ ПЛАН
            </h1>
            ...
            <div className="text-xl xs:text-2xl sm:text-3xl lg:text-5xl font-oswald font-bold text-graffiti-red mb-1 xs:mb-2 leading-tight">
              454 000
