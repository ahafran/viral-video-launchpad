  ...
  const steps = [
    {
      ...
      description:
        "Профессиональный монтажник создает цепляющий контент из ваших материалов",
      icon: "🎬",
      color: "graffiti-red",
    },
    {
      ...
      description:
        "Автоматическое размещение на сотнях аккаунтов в TikTok, Instagram, YouTube Shorts",
      icon: "🚀",
      color: "graffiti-gold",
    },
    {
      ...
      description: "Рост просмотров, подписчиков и узнаваемости вашего бренда",
      icon: "💥",
      color: "graffiti-red",
    },
  ];
